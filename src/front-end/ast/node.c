...
char* zenit_node_uid(struct ZenitNode *node)
{
    ...
    switch (node->nodekind)
    {
        ...
        case ZENIT_NODE_TYPE_BOOL:
            return zenit_node_type_bool_uid((struct ZenitBoolTypeNode*) node);
...
char* zenit_node_dump(struct ZenitNode *node, char *output)
{
    ...
    switch (node->nodekind)
    {
        ...
        case ZENIT_NODE_TYPE_BOOL:
            return zenit_node_type_bool_dump((struct ZenitBoolTypeNode*) node, output);
...
void zenit_node_free(struct ZenitNode *node)
{
    ...
    switch (node->nodekind)
    {
        ...
        case ZENIT_NODE_TYPE_BOOL:
            zenit_node_type_bool_free((struct ZenitBoolTypeNode*) node);
            break;
