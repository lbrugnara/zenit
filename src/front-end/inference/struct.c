 ...
 */
static ZenitSymbol* visit_named_struct_node(ZenitContext *ctx, ZenitStructNode *struct_node, ZenitType **ctx_type, ZenitInferenceKind infer_kind)
{
 ...
 *  <ZenitSymbol>* - The struct symbol with its type information
 */
static ZenitSymbol* visit_unnamed_struct_node(ZenitContext *ctx, ZenitStructNode *struct_node, ZenitType **ctx_type, ZenitInferenceKind infer_kind)
{
    ZenitSymbol *struct_symbol = zenit_utils_get_tmp_symbol(ctx->program, (ZenitNode*) struct_node);
