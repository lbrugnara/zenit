 ...
 */
static inline ZenitSymbol* zenit_infer_types_in_variable_node(ZenitContext *ctx, ZenitVariableNode *variable_node, ZenitType **ctx_type, ZenitInferenceKind infer_kind)
{
