...
bool zenit_typesys_unify_array(struct ZenitTypeSystem *typesys, struct ZenitArrayType *array_type, struct ZenitType *type_b, struct ZenitType **dest)
{
    ...
    {
        *dest = (struct ZenitType*) zenit_typesys_copy_array(typesys, array_type);
        return true;
    }
...
bool zenit_typesys_unify_reference(struct ZenitTypeSystem *typesys, struct ZenitReferenceType *ref_type, struct ZenitType *type_b, struct ZenitType **dest)
{
    ...
    if (type_b->typekind == ZENIT_TYPE_NONE)
    {
        *dest = (struct ZenitType*) zenit_typesys_copy_reference(typesys, ref_type);
        return true;
    }
    ...
    *dest = (struct ZenitType*) zenit_typesys_new_reference(typesys, unified_element_type);

    return true;
}

bool zenit_typesys_unify_struct(struct ZenitTypeSystem *typesys, struct ZenitStructType *struct_type, struct ZenitType *type_b, struct ZenitType **dest)
{
    ...
    if (type_b->typekind == ZENIT_TYPE_NONE)
    {
        *dest = (struct ZenitType*) zenit_typesys_copy_struct(typesys, struct_type);
        return true;
    }
...
bool zenit_typesys_unify_uint(struct ZenitTypeSystem *typesys, struct ZenitUintType *uint_type, struct ZenitType *type_b, struct ZenitType **dest)
{
    ...
    {
        *dest = (struct ZenitType*) zenit_typesys_copy_uint(typesys, uint_type);
        return true;
    }

    // At this point, type_b must be a uint
    struct ZenitUintType *uint_b = (struct ZenitUintType*) type_b;
    *dest = (struct ZenitType*) zenit_typesys_copy_uint(typesys, uint_type->size > uint_b->size ? uint_type : uint_b);
    return true;
}
...
bool zenit_typesys_unify_types(struct ZenitTypeSystem *typesys, struct ZenitType *type_a, struct ZenitType *type_b, struct ZenitType **dest)
{
    ...
    if (type_a->typekind == ZENIT_TYPE_NONE)
    {
        ...
        *dest = zenit_typesys_copy_type(typesys, type_b);
        return true;
    }
