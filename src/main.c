#include "front-end/passes/check.h"
#include "front-end/passes/infer.h"
#include "front-end/passes/parse.h"
#include "front-end/passes/resolve.h"
#include "front-end/symtable.h"
#include "front-end/passes/zirgen.h"
